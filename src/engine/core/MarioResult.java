...
public class MarioResult {
     ...
     * @param gameEvents   the events that happen in the world in the playthrough of the game
     * @param agentEvents the events that the agent performs in the playthrough of the game
     */
